export const REALTOR = {
    URL: {
        LOCATION:
            'https://parser-external.geo.moveaws.com/suggest?input=QUERY&client_id=rdc-home&limit=10&area_types=address%2Cneighborhood%2Ccity%2Ccounty%2Cpostal_code%2Cstreet%2Cschool%2Cschool_district%2Cuniversity%2Cpark%2Cstate%2Cmlsid&lat=-1&long=-1'
    },
    PLACE_TYPE: {
        county: 'county',
        zipcode: 'postal_code',
