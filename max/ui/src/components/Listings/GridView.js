...
export const GridView = ({ source, listings, onClick }) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            valueGetter: (params) => getRealtorUrl(source, params.row.zpid, params.row.url),
            renderCell: ({ value }) => {
                return (
                    <IconButton href={value} rel="noreferrer" target="_blank" style={{ color: SOURCE[source].color }}>
    ...
    const showColumns = [...columns, source !== 'redfin' && detailsColumn];
    ...
    return (
        <>
            ...
            >
                {field === 'zlink' ? (
                    <Iframe
                        url={getRealtorUrl(source, value.zpid)}
                        width="300px"
                        height="200px"
                        id=""
                        className=""
                    ...
                    <Card sx={{ maxWidth: 245, minWidth: 245 }}>
                        <CardMedia sx={{ maxHeight: 200, height: 175 }} image={value.imgSrc} title="property" />
                        <CardContent>
                            <Table density="dense" size="small">
                                <TableHead>
                                    <TableRow>
                                        <TableCell align="center" padding="none" variant="header">
                                            Price
                                        </TableCell>
                                        <TableCell align="center" padding="none" variant="header">
                                            Acres
                                ...
                                <TableBody>
                                    <TableRow>
                                        ...
                                        <TableCell align="center" padding="none">
                                            {USDollar.format(value.unformattedPpa)}
                                        </TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
