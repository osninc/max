...
const createSessionFunctionBuilder = (createSessionFunctionBuilderOptions) => {
    const { proxyConfiguration, proxyUrlBuilder, websiteUrl, cookiesTargetDomains = [], extraRequestOptions = {}, extraLaunchContextOptions = {}, extraLaunchOptions = {}, gotoOptions = {}, expectedResponseStatusCode = 200, useBrowser = false, withProxyInfo = false, postCreationFunction = async () => {
        void 0;
    ...
    return async (sessionPool, options) => {
        ...
        let proxyUrl = proxyUrlBuilder ? proxyUrlBuilder() : undefined;
        if (!proxyUrl) {
