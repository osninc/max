...
import { calcDom } from '../functions/formulas.js';
...
const DataTable = ({ details }) => {
    ...
    const word = details.statusType.toLowerCase().replace('_', ' ');
...
export const DetailsViewForBroker = ({ details: property, onClose }) => {
        ...
        <>
            ...
            <Card>
                <CardHeader
                    ...
                    title={<strong>{USDollar.format(property['unformattedPrice'])}</strong>}
                    subheader={property['streetAddress']}
                />
                <CardMedia
                    component="img"
                    width={imgWidth}
                    image={property['imgSrc']?.toString()}
                    loading="lazy"
                    alt={property.zpid}
                />
                <CardContent>
                ...
                <CardActions disableSpacing>
                    <Button
                        aria-label={`directions to ${property.streetAddress}`}
                        href={getGoogleMapsUrl(property.streetAddress)}
                        rel="noreferrer"
                        target="_blank"
                        //variant="link"
                    >
...
DetailsViewForBroker.propTypes = {
    details: PropTypes.object,
